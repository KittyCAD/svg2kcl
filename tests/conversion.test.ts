...
|> bezierCurve({
  ...
  to = [-247.54289, -239.02447]
}, %)
|> bezierCurve({
  control1 = [-14.499570000000006, -24.290489999999977],
  control2 = [-26.942309999999992, -50.06047000000001],
...
|> bezierCurve({
  ...
  to = [53.31366, 2.6553200000000174]
}, %)
|> bezierCurve({
  control1 = [26.617370000000022, 24.003980000000013],
  control2 = [60.96752000000001, 77.39654000000002],
...
|> bezierCurve({
  control1 = [-47.508249999999975, 44.85069999999999],
  control2 = [-93.61532999999997, 91.18793],
  to = [-142.09999999999997, 135.0005]
}, %)
|> bezierCurve({
  control1 = [-6.492439999999988, -2.6162860000000023],
  control2 = [-12.725549999999998, -5.812081000000006],
  to = [-19, -8.900000000000006]
}, %)
|> close(%)

sketch002 = startSketchAt([491.862, -147.111])
|> bezierCurve({
  control1 = [49.47034000000002, -9.290989999999994],
...
sketch003 = startSketchAt([464.862, -163.512])
|> bezierCurve({
  control1 = [-45.24450999999999, -1.4123600000000067],
...
|> bezierCurve({
  ...
  to = [-65.38021000000003, 59.91783000000001]
}, %)
|> close(%)

sketch004 = startSketchAt([199.362, -269.112])
|> bezierCurve({
...
|> bezierCurve({
  control1 = [-6.3039092, -14.089689999999962],
  control2 = [-15.8314797, -63.02475999999996],
  to = [5.331261999999999, -29.303020000000004]
}, %)
|> bezierCurve({
...
sketch005 = startSketchAt([313.962, -350.012])
|> bezierCurve({
  control1 = [-57.276340000000005, -43.24597],
  control2 = [-100.42605999999998, -101.63886000000002],
  to = [-150.7122, -152.29607]
}, %)
|> bezierCurve({
  control1 = [-19.362179999999995, -20.637779999999964],
  control2 = [-38.768879999999996, -41.239499999999964],
  to = [-57.62779999999999, -62.340930000000014]
}, %)
|> bezierCurve({
  control1 = [73.3455, 61.80097000000001],
...
sketch006 = startSketchAt([160.662, -404.412])
|> bezierCurve({
  control1 = [-78.859718, -46.75063],
  control2 = [-116.17863600000001, -138.84679999999997],
  to = [-128.4917, -225.96999999999997]
}, %)
|> bezierCurve({
  control1 = [34.700479, -7.06110000000001],
  control2 = [68.879, 10.585289999999986],
  to = [102.20963999999998, 18.26814999999999]
}, %)
|> bezierCurve({
  control1 = [56.84801999999999, 19.340730000000008],
  control2 = [113.22475, 52.00050999999996],
  to = [143.58206, 105.71485000000001]
}, %)
|> bezierCurve({
  control1 = [-35.01498000000001, 10.78870999999998],
  control2 = [-50.039739999999995, -33.62281999999999],
  to = [-75.21843999999999, -44.85341999999997]
}, %)
|> bezierCurve({
  control1 = [-39.38342, -22.79912999999999],
  control2 = [-83.77005, -35.41447000000005],
  to = [-128.38116, -43.05957999999998]
}, %)
|> bezierCurve({
  control1 = [12.803672000000006, 70.15551000000005],
  control2 = [44.05179, 142.61194999999998],
  to = [105.99960000000002, 182.60000000000002]
}, %)
|> bezierCurve({
  control1 = [-5.047840000000008, 4.844319999999982],
  control2 = [-12.440930000000009, 16.601639999999975],
  to = [-19.69999999999999, 7.300000000000011]
}, %)
|> close(%)

sketch007 = startSketchAt([402.862, -456.712])
|> bezierCurve({
...
sketch008 = startSketchAt([530.388, -49.9619])
|> bezierCurve({
  control1 = [38.32407999999998, -38.100284],
  control2 = [76.64832000000001, -76.20042],
  to = [114.97299999999996, -114.3001]
}, %)
|> bezierCurve({
  control1 = [20.244950000000017, 52.41606],
  control2 = [31.04894999999999, 108.03260399999999],
  to = [36.495000000000005, 163.8224]
}, %)
|> bezierCurve({
  control1 = [-52.81866000000002, -7.284511800000001],
